...
fn test_ucomisd_instruction() {
    ...
    let result = execute_instruction(&[0x66, 0x0F, 0x2E, 0xC1], &mut state);
...
fn test_ucomiss_instruction() {
    ...
    let result = execute_instruction(&[0x0F, 0x2E, 0xC1], &mut state);
...
fn test_ud0_instruction() {
    ...
    let result = execute_instruction(&[0x0F, 0xFF, 0xC3], &mut state);
...
fn test_ud1_instruction() {
    ...
    let result = execute_instruction(&[0x0F, 0xB9, 0xC3], &mut state);
...
fn test_ud2_instruction() {
    ...
    // UD2 (0x0F 0x0B)
    let result = execute_instruction(&[0x0F, 0x0B], &mut state);
...
fn test_unpckhpd_instruction() {
    ...
    let result = execute_instruction(&[0x66, 0x0F, 0x15, 0xC1], &mut state);
...
fn test_unpckhps_instruction() {
    ...
    let result = execute_instruction(&[0x0F, 0x15, 0xC1], &mut state);
...
fn test_unpcklpd_instruction() {
    ...
    let result = execute_instruction(&[0x66, 0x0F, 0x14, 0xC1], &mut state);
...
fn test_unpcklps_instruction() {
    ...
    let result = execute_instruction(&[0x0F, 0x14, 0xC1], &mut state);
...
fn test_ud0_with_different_registers() {
    ...
    let result = execute_instruction(&[0x0F, 0xFF, 0xCA], &mut state);
...
fn test_umonitor_with_different_address() {
    ...
    assert!(result.is_ok());
    assert_eq!(state.registers.rbx, 0x2000u64);
}
