...
fn test_xor_16bit_instruction() {
    ...
    let result = execute_instruction(&[0x66, 0x31, 0xD8], &mut state);
...
fn test_xor_32bit_instruction() {
    ...
    let result = execute_instruction(&[0x31, 0xD8], &mut state);
...
fn test_xor_memory_instruction() {
    ...
    let result = execute_instruction(&[0x48, 0x33, 0x03], &mut state);
...
fn test_xor_immediate_instruction() {
    ...
    let result = execute_instruction(&[0x48, 0x35, 0x78, 0x56, 0x34, 0x12], &mut state);
...
fn test_xor_flags() {
    ...
    let result = execute_instruction(&[0x48, 0x31, 0xC0], &mut state);
...
fn test_xchg_instruction() {
    ...
    let result = execute_instruction(&[0x48, 0x87, 0xD8], &mut state);
...
fn test_xchg_16bit_instruction() {
    ...
    let result = execute_instruction(&[0x66, 0x87, 0xD8], &mut state);
...
fn test_xchg_memory_instruction() {
    ...
    let result = execute_instruction(&[0x48, 0x87, 0x03], &mut state);
...
fn test_xlat_instruction() {
    ...
    let result = execute_instruction(&[0xD7], &mut state);
