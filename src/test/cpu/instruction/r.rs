...
mod tests {
    ...
    fn test_rol_instruction() {
        ...
        let result = execute_instruction(&[0x48, 0xC1, 0xC0, 0x04], &mut state).unwrap();
    ...
    fn test_ror_instruction() {
        ...
        let result = execute_instruction(&[0x48, 0xC1, 0xC8, 0x04], &mut state).unwrap();
    ...
    fn test_rcl_instruction() {
        ...
        let result = execute_instruction(&[0x48, 0xD1, 0xD0], &mut state).unwrap();
    ...
    fn test_rcr_instruction() {
        ...
        let result = execute_instruction(&[0x48, 0xD1, 0xD8], &mut state).unwrap();
    ...
    fn test_rdrand_instruction() {
        ...
        let result = execute_instruction(&[0x48, 0x0F, 0xC7, 0xF0], &mut state).unwrap();
    ...
    fn test_rdseed_instruction() {
        ...
        let result = execute_instruction(&[0x48, 0x0F, 0xC7, 0xF8], &mut state).unwrap();
    ...
    fn test_rsm_instruction() {
        ...
        let result = execute_instruction(&[0x0F, 0xAA], &mut state).unwrap();
    ...
    fn test_rol_32_bit_register() {
        ...
        let result = execute_instruction(&[0xC1, 0xC0, 0x04], &mut state).unwrap();
    ...
    fn test_ror_16_bit_register() {
        ...
        let result = execute_instruction(&[0x66, 0xC1, 0xC8, 0x04], &mut state).unwrap();
    ...
    fn test_rdrand_different_registers() {
        ...
        let result = execute_instruction(&[0x48, 0x0F, 0xC7, 0xF3], &mut state).unwrap();
