...
mod tests {
    ...
    fn test_ja_instruction() {
        ...
        let result = execute_instruction(&[0x77, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jae_instruction() {
        ...
        let result = execute_instruction(&[0x73, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jb_instruction() {
        ...
        let result = execute_instruction(&[0x72, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jbe_instruction() {
        ...
        let result = execute_instruction(&[0x76, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jcxz_instruction() {
        ...
        let result = execute_instruction(&[0xE3, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_je_instruction() {
        ...
        let result = execute_instruction(&[0x74, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jg_instruction() {
        ...
        let result = execute_instruction(&[0x7F, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jge_instruction() {
        ...
        let result = execute_instruction(&[0x7D, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jl_instruction() {
        ...
        let result = execute_instruction(&[0x7C, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jle_instruction() {
        ...
        let result = execute_instruction(&[0x7E, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jmp_instruction() {
        ...
        let result = execute_instruction(&[0xEB, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jne_instruction() {
        ...
        let result = execute_instruction(&[0x75, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jno_instruction() {
        ...
        let result = execute_instruction(&[0x71, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jns_instruction() {
        ...
        let result = execute_instruction(&[0x79, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jo_instruction() {
        ...
        let result = execute_instruction(&[0x70, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_js_instruction() {
        ...
        let result = execute_instruction(&[0x78, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jmpe_instruction() {
        ...
        let state = create_test_cpu_state().unwrap();
        let result = execute_instruction(&[0x0F, 0xB8, 0xC0], state);
    ...
    fn test_jnp_instruction() {
        ...
        let result = execute_instruction(&[0x7B, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jp_instruction() {
        ...
        let result = execute_instruction(&[0x7A, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jknzd_instruction() {
        ...
        let state = create_test_cpu_state().unwrap();
        let result = execute_instruction(&[0x62, 0xF1, 0x7D, 0x08, 0xE0, 0x10], state);
        assert!(result.is_ok());
    }
    ...
    fn test_jkzd_instruction() {
        ...
        let state = create_test_cpu_state().unwrap();
        let result = execute_instruction(&[0x62, 0xF1, 0x7D, 0x08, 0xE1, 0x10], state);
        assert!(result.is_ok());
    }
}
