...
fn test_aaa_instruction() {
    ...
    let result = execute_instruction(&[0x37], &mut state);
    ...
    let result = execute_instruction(&[0x37], &mut state); // AAA
...
fn test_aad_instruction() {
    ...
    let result = execute_instruction(&[0xD5, 0x0A], &mut state);
    assert!(result.is_err());
...
fn test_aam_instruction() {
    ...
    let result = execute_instruction(&[0xD4, 0x0A], &mut state);
    assert!(result.is_err());
...
fn test_aas_instruction() {
    ...
    let result = execute_instruction(&[0x3F], &mut state);
    assert!(result.is_err());
...
fn test_arpl_instruction() {
    ...
    let result = execute_instruction(&[0x63, 0xC1], &mut state);
